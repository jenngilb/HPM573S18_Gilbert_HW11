...
import scr.InOutFunctions as OutSupport
...
class UrgentCare:
    def __init__(self, idn):
        ...
        self.simCal = SimLib.SimulationCalendar()

        # set up trace
        self.trace = SimLib.Trace(self.simCal, P.TRACE_ON, P.DECI)
...
class Parameters:
    ...
    def __init__(self):
        self.hoursOpen = P.HOURS_OPEN
        self.nExamRooms = P.N_EXAM_ROOMS
        self.arrivalTimeDist = RVGs.Exponential(scale=P.MEAN_ARRIVAL_TIME)
        self.examTimeDist = RVGs.Exponential(scale=P.MEAN_EXAM_DURATION)
...
class SimOutputs:
    ...
    def print_outputs(self):
        ...
        summary = [
            ...
            self.patientsInSystem.get_summary(P.ALPHA, P.DECI),
            self.urgentCare.waitingRoom.numPatientsWaiting.get_summary(P.ALPHA, P.DECI),
            self.patientTimeInSystem.get_summary(P.ALPHA, P.DECI),
            self.patientWaitingTime.get_summary(P.ALPHA, P.DECI),
            self.examRoomsUtil.get_summary(P.ALPHA, P.DECI)
        ]
...
class ColOfUrgentCares:
    ...
    def simulate(self):
        ...
        for i in range(len(self.ids)):
            ...
            # simulate the urgent care
            sim_output = urgent_care.simulate(P.SIM_DURATION)
    ...
    def print_outputs(self):
        ...
        summary = [
            ['Output', 'Mean', 'Confidence Interval', 'Prediction Interval', 'St. Dev.', 'Minimum', 'Maximum'],
            n_patients_arrived.get_summary(P.ALPHA, P.DECI),
            n_patients_served.get_summary(P.ALPHA, P.DECI),
            ave_patients_in_system.get_summary(P.ALPHA, P.DECI),
            ave_patients_waiting.get_summary(P.ALPHA, P.DECI),
            ave_patient_time_in_system.get_summary(P.ALPHA, P.DECI),
            ave_patient_waiting_time.get_summary(P.ALPHA, P.DECI),
            ave_exam_rooms_utilization.get_summary(P.ALPHA, P.DECI)
        ]
